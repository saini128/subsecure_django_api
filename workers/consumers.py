...
class WorkerConsumer(AsyncWebsocketConsumer):
    ...
    def get_workers(self):
        ...
        return list(Worker.objects.select_related('location').values('id','name', 'age', 'location_id', 'sos', 'available'))
class LocationConsumer(AsyncWebsocketConsumer):
    ...
    def get_locations(self):
        ...
        return list(Location.objects.values('id','description', 'temperature', 'humidity','number_of_workers','emergency_bit','available'))
